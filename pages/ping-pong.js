    ...
    if (typeof window !== 'undefined') {
      import('phaser').then((Phaser) => {
        ...
        function update() {
          ...
          player1.y = Phaser.default.Math.Clamp(player1.y, player1.height / 2, 600 - player1.height / 2);
          player2.y = Phaser.default.Math.Clamp(player2.y, player2.height / 2, 600 - player2.height / 2);
        }

    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push('</div>',
            '<div class="pull-right pagination">',
                '<ul class="pagination">',
                    '<li class="page-first"><a href="javascript:void(0)"><i class="fa fa-angle-double-left fa-lg"></i></a></li>',
                    '<li class="page-pre"><a href="javascript:void(0)"><i class="fa fa-angle-left fa-lg"></i></a></li>');
        ...
        html.push(
                    '<li class="page-next"><a href="javascript:void(0)"><i class="fa fa-angle-right fa-lg"></i></a></li>',
                    '<li class="page-last"><a href="javascript:void(0)"><i class="fa fa-angle-double-right fa-lg"></i></a></li>',
                '</ul>',
            '</div>');
